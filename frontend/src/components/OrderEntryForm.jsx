      ...
      <div className="mb-4 flex justify-center gap-x-2">
        {availableExchanges.map((exchange) => {
          ...
          const colorClasses = isSelected
            ? 'bg-blue-700 text-white-900 border-blue-400' // Selected: slightly darker blue
            : 'bg-blue-400 text-blue-700 border-blue-200 hover:bg-blue-100'; // Unselected: light blue
          ...
          return (
            <button
              ...
              className={`px-2 py-1 text-xs font-medium border transition-colors rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-300 ${colorClasses}`}
            >
              {exchange}
            </button>
          );
